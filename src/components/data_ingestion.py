...
password = urllib.parse.quote_plus('Kaizen@123')


MONGO_DB_URL = f"mongodb+srv://{username}:{password}@cluster0.bt51f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
